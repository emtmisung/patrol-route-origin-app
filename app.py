        ...
        with st.expander("📌 PC·휴대폰에 바로가기 만들기", expanded=False):
            st.markdown(
                ...
                **🖥️ PC — Chrome**
                ...
                1. 오른쪽 위 **⋮**를 누릅니다.
                2. **전송·저장·공유 → 바로가기 만들기** 또는 **앱 설치**를 선택합니다.
                3. 이름을 `파세루 오리진`으로 확인하고 **만들기/설치**를 누릅니다.

                **📱 안드로이드 휴대폰 — Chrome 등**

                1. 브라우저 메뉴 **⋮ 또는 ☰**를 누릅니다.
                2. **홈 화면에 추가**, **앱 설치** 또는 **현재 페이지 추가 → 홈 화면**을 선택합니다.
                3. 이름을 확인하고 **추가/설치**를 누릅니다.

                `홈 화면에 추가` 대신 **앱 열기**가 보이면 이미 설치된 상태일 수 있습니다.
                휴대폰의 전체 앱 목록에서 `파세루`, `Streamlit`을 검색한 뒤 아이콘을 길게 눌러 홈 화면에 놓으세요.
            ...
            st.caption("메뉴 이름은 기기와 브라우저 버전에 따라 조금 다를 수 있습니다. 아래 주소는 복사해서 사용할 수 있습니다.")
